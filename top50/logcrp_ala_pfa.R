...
histogram(meta_logspecies$logala_pfa)
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_uniformis + logala_pfa*s__Bacteroides_uniformis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_vulgatus + logala_pfa*s__Bacteroides_vulgatus 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
summary(reg)
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Eubacterium_rectale + logala_pfa*s__Eubacterium_rectale 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Prevotella_copri + logala_pfa*s__Prevotella_copri 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Alistipes_putredinis + logala_pfa*s__Alistipes_putredinis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_dorei + logala_pfa*s__Bacteroides_dorei 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Eubacterium_eligens + logala_pfa*s__Eubacterium_eligens 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Roseburia_faecis + logala_pfa*s__Roseburia_faecis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_stercoris + logala_pfa*s__Bacteroides_stercoris 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Eubacterium_siraeum + logala_pfa*s__Eubacterium_siraeum 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Ruminococcus_bromii + logala_pfa*s__Ruminococcus_bromii 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Fusicatenibacter_saccharivorans + logala_pfa*s__Fusicatenibacter_saccharivorans 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Parabacteroides_distasonis + logala_pfa*s__Parabacteroides_distasonis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Akkermansia_muciniphila + logala_pfa*s__Akkermansia_muciniphila 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_eggerthii + logala_pfa*s__Bacteroides_eggerthii 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Ruminococcus_bicirculans + logala_pfa*s__Ruminococcus_bicirculans 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_cellulosilyticus + logala_pfa*s__Bacteroides_cellulosilyticus 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_thetaiotaomicron + logala_pfa*s__Bacteroides_thetaiotaomicron 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Anaerostipes_hadrus + logala_pfa*s__Anaerostipes_hadrus 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Collinsella_aerofaciens + logala_pfa*s__Collinsella_aerofaciens 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_ovatus + logala_pfa*s__Bacteroides_ovatus 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Roseburia_intestinalis + logala_pfa*s__Roseburia_intestinalis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Alistipes_finegoldii + logala_pfa*s__Alistipes_finegoldii 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Parabacteroides_merdae + logala_pfa*s__Parabacteroides_merdae 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Barnesiella_intestinihominis + logala_pfa*s__Barnesiella_intestinihominis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_caccae + logala_pfa*s__Bacteroides_caccae 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_plebeius + logala_pfa*s__Bacteroides_plebeius 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Dorea_longicatena + logala_pfa*s__Dorea_longicatena 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Escherichia_coli + logala_pfa*s__Escherichia_coli 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Ruminococcus_torques + logala_pfa*s__Ruminococcus_torques 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Lachnospira_pectinoschiza + logala_pfa*s__Lachnospira_pectinoschiza 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Coprococcus_eutactus + logala_pfa*s__Coprococcus_eutactus 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Butyrivibrio_crossotus + logala_pfa*s__Butyrivibrio_crossotus 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Roseburia_inulinivorans + logala_pfa*s__Roseburia_inulinivorans 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bifidobacterium_adolescentis + logala_pfa*s__Bifidobacterium_adolescentis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Oscillibacter_sp_57_20 + logala_pfa*s__Oscillibacter_sp_57_20 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Eubacterium_sp_CAG_180 + logala_pfa*s__Eubacterium_sp_CAG_180 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Eubacterium_hallii + logala_pfa*s__Eubacterium_hallii 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_intestinalis + logala_pfa*s__Bacteroides_intestinalis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Blautia_wexlerae + logala_pfa*s__Blautia_wexlerae 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Blautia_obeum + logala_pfa*s__Blautia_obeum 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bifidobacterium_longum + logala_pfa*s__Bifidobacterium_longum 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Coprococcus_comes + logala_pfa*s__Coprococcus_comes 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Roseburia_hominis + logala_pfa*s__Roseburia_hominis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Ruminococcus_lactaris + logala_pfa*s__Ruminococcus_lactaris 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_fragilis + logala_pfa*s__Bacteroides_fragilis 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Odoribacter_splanchnicus + logala_pfa*s__Odoribacter_splanchnicus 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Butyrivibrio_sp_CAG_318 + logala_pfa*s__Butyrivibrio_sp_CAG_318 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logala_pfa + s__Bacteroides_xylanisolvens + logala_pfa*s__Bacteroides_xylanisolvens 
             +logala_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
a$name <- gsub("logala_pfa:s__", "", rownames(a))
a$stars <- cut(a$`Pr(>F)`, breaks=c(-Inf, 0.01, 0.05, 0.10, Inf), label=c("***","**", "*", ""))

write.table(a, file = "./data/logcrp_logala_pfa.pcl",  sep = '\t', quote = F, eol = '\n',  row.names=T)
...
ggplot(a, aes(name, beta)) +
  ...
  coord_flip()+
  labs(title ="logcrp_logala_pfa.pcl")+
