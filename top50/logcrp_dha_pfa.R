...
histogram(meta_logspecies$logdha_pfa)
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_uniformis + logdha_pfa*s__Bacteroides_uniformis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_vulgatus + logdha_pfa*s__Bacteroides_vulgatus 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
summary(reg)
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Eubacterium_rectale + logdha_pfa*s__Eubacterium_rectale 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Prevotella_copri + logdha_pfa*s__Prevotella_copri 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Alistipes_putredinis + logdha_pfa*s__Alistipes_putredinis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_dorei + logdha_pfa*s__Bacteroides_dorei 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Eubacterium_eligens + logdha_pfa*s__Eubacterium_eligens 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Roseburia_faecis + logdha_pfa*s__Roseburia_faecis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_stercoris + logdha_pfa*s__Bacteroides_stercoris 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Eubacterium_siraeum + logdha_pfa*s__Eubacterium_siraeum 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Ruminococcus_bromii + logdha_pfa*s__Ruminococcus_bromii 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Fusicatenibacter_saccharivorans + logdha_pfa*s__Fusicatenibacter_saccharivorans 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Parabacteroides_distasonis + logdha_pfa*s__Parabacteroides_distasonis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Akkermansia_muciniphila + logdha_pfa*s__Akkermansia_muciniphila 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_eggerthii + logdha_pfa*s__Bacteroides_eggerthii 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Ruminococcus_bicirculans + logdha_pfa*s__Ruminococcus_bicirculans 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_cellulosilyticus + logdha_pfa*s__Bacteroides_cellulosilyticus 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_thetaiotaomicron + logdha_pfa*s__Bacteroides_thetaiotaomicron 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Anaerostipes_hadrus + logdha_pfa*s__Anaerostipes_hadrus 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Collinsella_aerofaciens + logdha_pfa*s__Collinsella_aerofaciens 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_ovatus + logdha_pfa*s__Bacteroides_ovatus 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Roseburia_intestinalis + logdha_pfa*s__Roseburia_intestinalis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Alistipes_finegoldii + logdha_pfa*s__Alistipes_finegoldii 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Parabacteroides_merdae + logdha_pfa*s__Parabacteroides_merdae 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Barnesiella_intestinihominis + logdha_pfa*s__Barnesiella_intestinihominis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_caccae + logdha_pfa*s__Bacteroides_caccae 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_plebeius + logdha_pfa*s__Bacteroides_plebeius 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Dorea_longicatena + logdha_pfa*s__Dorea_longicatena 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Escherichia_coli + logdha_pfa*s__Escherichia_coli 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Ruminococcus_torques + logdha_pfa*s__Ruminococcus_torques 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Lachnospira_pectinoschiza + logdha_pfa*s__Lachnospira_pectinoschiza 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Coprococcus_eutactus + logdha_pfa*s__Coprococcus_eutactus 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Butyrivibrio_crossotus + logdha_pfa*s__Butyrivibrio_crossotus 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Roseburia_inulinivorans + logdha_pfa*s__Roseburia_inulinivorans 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bifidobacterium_adolescentis + logdha_pfa*s__Bifidobacterium_adolescentis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Oscillibacter_sp_57_20 + logdha_pfa*s__Oscillibacter_sp_57_20 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Eubacterium_sp_CAG_180 + logdha_pfa*s__Eubacterium_sp_CAG_180 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Eubacterium_hallii + logdha_pfa*s__Eubacterium_hallii 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_intestinalis + logdha_pfa*s__Bacteroides_intestinalis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Blautia_wexlerae + logdha_pfa*s__Blautia_wexlerae 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Blautia_obeum + logdha_pfa*s__Blautia_obeum 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bifidobacterium_longum + logdha_pfa*s__Bifidobacterium_longum 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Coprococcus_comes + logdha_pfa*s__Coprococcus_comes 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Roseburia_hominis + logdha_pfa*s__Roseburia_hominis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Ruminococcus_lactaris + logdha_pfa*s__Ruminococcus_lactaris 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_fragilis + logdha_pfa*s__Bacteroides_fragilis 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Odoribacter_splanchnicus + logdha_pfa*s__Odoribacter_splanchnicus 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Butyrivibrio_sp_CAG_318 + logdha_pfa*s__Butyrivibrio_sp_CAG_318 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logdha_pfa + s__Bacteroides_xylanisolvens + logdha_pfa*s__Bacteroides_xylanisolvens 
             +logdha_ddr+agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
a$name <- gsub("logdha_pfa:s__", "", rownames(a))
a$stars <- cut(a$`Pr(>F)`, breaks=c(-Inf, 0.01, 0.05, 0.10, Inf), label=c("***","**", "*", ""))

write.table(a, file = "./data/logcrp_logdha_pfa.pcl",  sep = '\t', quote = F, eol = '\n',  row.names=T)
...
ggplot(a, aes(name, beta)) +
  ...
  coord_flip()+
  labs(title ="logcrp_logdha_pfa.pcl")+
