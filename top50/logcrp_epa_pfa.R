...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_uniformis + logepa_pfa*s__Bacteroides_uniformis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_vulgatus + logepa_pfa*s__Bacteroides_vulgatus 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
summary(reg)
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Eubacterium_rectale + logepa_pfa*s__Eubacterium_rectale 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Prevotella_copri + logepa_pfa*s__Prevotella_copri 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Alistipes_putredinis + logepa_pfa*s__Alistipes_putredinis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_dorei + logepa_pfa*s__Bacteroides_dorei 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Eubacterium_eligens + logepa_pfa*s__Eubacterium_eligens 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Roseburia_faecis + logepa_pfa*s__Roseburia_faecis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_stercoris + logepa_pfa*s__Bacteroides_stercoris 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Eubacterium_siraeum + logepa_pfa*s__Eubacterium_siraeum 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Ruminococcus_bromii + logepa_pfa*s__Ruminococcus_bromii 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Fusicatenibacter_saccharivorans + logepa_pfa*s__Fusicatenibacter_saccharivorans 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Parabacteroides_distasonis + logepa_pfa*s__Parabacteroides_distasonis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Akkermansia_muciniphila + logepa_pfa*s__Akkermansia_muciniphila 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_eggerthii + logepa_pfa*s__Bacteroides_eggerthii 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Ruminococcus_bicirculans + logepa_pfa*s__Ruminococcus_bicirculans 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_cellulosilyticus + logepa_pfa*s__Bacteroides_cellulosilyticus 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_thetaiotaomicron + logepa_pfa*s__Bacteroides_thetaiotaomicron 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Anaerostipes_hadrus + logepa_pfa*s__Anaerostipes_hadrus 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Collinsella_aerofaciens + logepa_pfa*s__Collinsella_aerofaciens 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_ovatus + logepa_pfa*s__Bacteroides_ovatus 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Roseburia_intestinalis + logepa_pfa*s__Roseburia_intestinalis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Alistipes_finegoldii + logepa_pfa*s__Alistipes_finegoldii 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Parabacteroides_merdae + logepa_pfa*s__Parabacteroides_merdae 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Barnesiella_intestinihominis + logepa_pfa*s__Barnesiella_intestinihominis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_caccae + logepa_pfa*s__Bacteroides_caccae 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_plebeius + logepa_pfa*s__Bacteroides_plebeius 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Dorea_longicatena + logepa_pfa*s__Dorea_longicatena 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Escherichia_coli + logepa_pfa*s__Escherichia_coli 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Ruminococcus_torques + logepa_pfa*s__Ruminococcus_torques 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Lachnospira_pectinoschiza + logepa_pfa*s__Lachnospira_pectinoschiza 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Coprococcus_eutactus + logepa_pfa*s__Coprococcus_eutactus 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Butyrivibrio_crossotus + logepa_pfa*s__Butyrivibrio_crossotus 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Roseburia_inulinivorans + logepa_pfa*s__Roseburia_inulinivorans 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bifidobacterium_adolescentis + logepa_pfa*s__Bifidobacterium_adolescentis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Oscillibacter_sp_57_20 + logepa_pfa*s__Oscillibacter_sp_57_20 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Eubacterium_sp_CAG_180 + logepa_pfa*s__Eubacterium_sp_CAG_180 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Eubacterium_hallii + logepa_pfa*s__Eubacterium_hallii 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_intestinalis + logepa_pfa*s__Bacteroides_intestinalis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Blautia_wexlerae + logepa_pfa*s__Blautia_wexlerae 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Blautia_obeum + logepa_pfa*s__Blautia_obeum 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bifidobacterium_longum + logepa_pfa*s__Bifidobacterium_longum 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Coprococcus_comes + logepa_pfa*s__Coprococcus_comes 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Roseburia_hominis + logepa_pfa*s__Roseburia_hominis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Ruminococcus_lactaris + logepa_pfa*s__Ruminococcus_lactaris 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_fragilis + logepa_pfa*s__Bacteroides_fragilis 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Odoribacter_splanchnicus + logepa_pfa*s__Odoribacter_splanchnicus 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Butyrivibrio_sp_CAG_318 + logepa_pfa*s__Butyrivibrio_sp_CAG_318 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
reg <- lmer( logcrp_plasma ~ logepa_pfa + s__Bacteroides_xylanisolvens + logepa_pfa*s__Bacteroides_xylanisolvens 
             +logepa_ddr +agemlvs+abx_ddr+probx_ddr+bristol_ddr+ smoke12 +calor_fs_dr_ddr 
             +(1 | ID1), data=meta_bispecies)
summary(reg)
a<- rbind(a, cbind(beta = reg@beta[length(reg@beta)],  anova(reg)[nrow(anova(reg)),]))
...
a$name <- gsub("logepa_pfa:s__", "", rownames(a))
a$stars <- cut(a$`Pr(>F)`, breaks=c(-Inf, 0.01, 0.05, 0.10, Inf), label=c("***","**", "*", ""))

write.table(a, file = "./data/logcrp_logepa_pfa.pcl",  sep = '\t', quote = F, eol = '\n',  row.names=T)
