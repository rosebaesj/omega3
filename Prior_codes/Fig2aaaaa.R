...
# read in metadata
species_filt <-read.table(file = './data/species_filt.csv',
...
sig_ala_avg <- sig_results(dir="./maaslin2/omega_output_ala_avg_fs_ffq_species_all/significant_results.tsv",  exposure = "ala_avg")
...
sig_ala_avg <- all_results(dir="./maaslin2/omega_output_ala_avg_fs_ffq_species_all/all_results.tsv",  exposure = "ala_avg", label="longtern_ala")
